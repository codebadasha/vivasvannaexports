...
<div class="page-content">
    <div class="container-fluid">
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('client.project.index') }}">Project List</a></li>
        ...
        <form class="custom-validation" action="{{ route('client.project.update') }}" method="post" id="project" enctype="multipart/form-data">
            @csrf  
                        ...
                        <div class="card-body">
                            ...
                            <div class="button-items">
                                <center>
                                    ...
                                    <a href="{{ route('client.project.index') }}" class="btn btn-danger waves-effect">
                                        Cancel
                                    </a>
                                </center>
                            </div>
