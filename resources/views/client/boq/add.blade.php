...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form class="custom-validation" action="{{ route('client.boq.store') }}" method="post" id="boqForm" enctype="multipart/form-data">
            @csrf  
            <div class="row">   
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="button-items">
                                <center>
                                    ...
                                    <a href="{{ route('client.boq.index') }}" class="btn btn-danger waves-effect">
                                        Cancel
                                    </a>
                                </center>
                            </div>
