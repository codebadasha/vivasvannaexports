                            ...
                            @if(!is_null($po))
                                @foreach($po as $ok => $ov)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('client.po.viewPurchaseOrder',base64_encode($ov->id)) }}" role="button">
                                                View PO
                                            </a>
                                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('client.po.invoiceList',base64_encode($ov->id)) }}" role="button">
                                                Invoices
                                            </a>
                                        </td>
                                    </tr>
