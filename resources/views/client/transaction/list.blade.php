    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('client.transaction.index') }}">
                            <div class="row">  
                                ...
                                <div class="col-md-2 mt-4">
                                    ...
                                    @if($filter == 1)
                                        <a href="{{ route('client.transaction.index') }}" class="btn btn-danger mt-1 cancel_button" id="filter" name="save_and_list" value="save_and_list">
                                            Reset
                                        </a>
                                    @endif
                                </div>
