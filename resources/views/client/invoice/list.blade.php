    ...
    <div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>View PO</td>
                                        <td>
                                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('client.po.viewPurchaseOrder',base64_encode($poDetail->id)) }}" role="button">
                                                View PO
                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('client.po.invoiceList',$id) }}">
                            <div class="row">  
                            ...
                            @if(!is_null($invoice))
                                @foreach($invoice as $ik => $iv)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('client.po.downloadInvoiceDocumentZip',base64_encode($iv->id)) }}" role="button" target="_blank">
                                                Download Documents
                                            </a>
                                        </td>
                                    </tr>
