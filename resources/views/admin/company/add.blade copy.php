...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form class="custom-validation" id="addClientCompany" action="{{ route('admin.client.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <input type="text" name="gstn" class="form-control" id="gstn" maxlength="15" minlength="15"
                                    placeholder="GSTN" required value="{{ old('gstn') }}">
                ...
                <div id="company-details" style="{{ old('gstn') ? '' : '' }}">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body row">
                                ...
                                <div class="form-group col-md-4 mb-3">
                                    <label>CIN</label>
                                    <input type="text" name="cin" class="form-control" id="cin" placeholder="CIN" readonly value="{{ old('cin') }}">
                                </div>
                                ...
                                <div class="form-group col-md-4 mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email ID "
                                        required readonly value="{{ old('email') }}">
                                </div>

                                <div class="form-group col-md-4 mb-3">
                                    <label>Contact number <span class="mandatory">*</span></label>
                                    @php
                                    $mobile = old('show_mobile_number', $user->mobile_number ?? ''); // take old or db value
                                    if ($mobile && strlen($mobile) >= 10) {
                                    $mobile = substr($mobile, 0, 2) . 'XXXXX' . substr($mobile, -3);
                                    }
                                    @endphp
                                    <input type="text" name="show_mobile_number" class="form-control numeric" id="showMobileNumber"
                                        placeholder="Contact number" required readonly value="{{ $mobile }}">
                                    <input type="hidden" name="mobile_number" class="form-control numeric" id="mobileNumber"
                                ...
                                <div class="button-items">
                                    <center>
                                        <button type="submit" class="btn btn-primary waves-effect waves-light mr-1"
                                            name="btn_submit" value="save">Save</button>
                                        <button type="submit" class="btn btn-secondary waves-effect waves-light mr-1"
                                            name="btn_submit" value="save_and_update">Save & Add New</button>
                                        <a href="{{ route('admin.client.index') }}" class="btn btn-danger waves-effect">Cancel</a>
                                    </center>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        window.checkGstURL = `{{ route('admin.client.gst.validate') }}`;
    });
</script>
