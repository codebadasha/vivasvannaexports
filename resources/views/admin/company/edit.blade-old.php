                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="authorizedPerson">
                                    ...
                                    if (!$authorized) {
                                        $authorized = $detail->authorized->toArray();
                                    ...
                                    <div class="row mb-3 authorized">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="authorized[{{ $ak }}][mobile]" minlength="10" maxlength="10"
                            ...
                            <div class="card-body">
                                <div class="contactPerson">
                                    ...
                                    <div class="row mb-3 contactperson">
                                        ...
                                        <div class="col-md-3">
                                            <label>Mobile Number <span class="mandatory">*</span></label>
                                            <input type="text" name="contact[{{ $ak }}][mobile]" minlength="10" class="form-control numeric" data-msg="Please enter mobile number" maxlength="10" minlength="10" placeholder="Mobile Number" value="{{ $av['mobile'] }}" required>
                                        </div>
                                        <div class="col-md-1 mt-4">
                                            @if($loop->first)
