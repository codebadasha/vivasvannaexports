                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm btn-success waves-effect waves-light resendInvitation" data-token="{{ $ov->token }}" title="Resend Invitation">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.copyInvitation', function() {
