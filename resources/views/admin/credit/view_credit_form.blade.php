        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Credit Form - {{ !is_null($creditRequest->client) ? $creditRequest->client->company_name : '--' }}</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('client.dashboard') }}">Credit Request</a></li>
                            <li class="breadcrumb-item active">Credit Form</li>
                        </ol>
                    </div>
                </div>
            </div>
