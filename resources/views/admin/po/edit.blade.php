...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form class="custom-validation" action="{{ route('admin.po.update') }}" method="post" id="addClientCompany" enctype="multipart/form-data">
            @csrf  
                            ...
                            <div class="contactPerson">
                                <div class="row mb-3 contactperson">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="credit_day" class="form-control numeric" data-msg="Please enter credit days" placeholder="Credit Days" value="{{ $detail->credit_day }}" required>
                                    </div>

                                    <div class="addNote">
                                        @if(!is_null($detail->note))
                                            @foreach($detail->note as $nk => $nv)
                                                <div class="newNote row">
                                                    <div class="col-md-6 mt-3">
                                                        <input type="text" name="note[]" class="form-control" data-msg="Please enter note" placeholder="Note" value="{{ $nv->note }}" required>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <a href="javscript:void(0);" class="btn btn-danger removeNote mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <a href="javascript:void(0);" class="btn btn-danger addNewNote mt-5 btn-sm">Add New Note</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="button-items">
                                <center>
                                    ...
                                    <a href="{{ route('admin.po.index') }}" class="btn btn-danger waves-effect">
                                        Cancel
                                    </a>
                                </center>
                            </div>
...
<script>
    ...
    $(document).on('click','.addNewNote',function(){
        var html = '<div class="newNote row"><div class="col-md-6 mt-3"><input type="text" name="note[]" class="form-control" data-msg="Please enter remarks" placeholder="Remarks" required></div><div class="col-md-1"><a href="javscript:void(0);" class="btn btn-danger removeNote mt-3"><i class="fa fa-trash"></i></a></div></div>';
        $('.addNote').append(html);
    })
