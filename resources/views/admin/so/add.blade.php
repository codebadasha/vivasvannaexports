...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form class="custom-validation" action="{{ route('admin.po.store') }}" method="post" id="addClientCompany" enctype="multipart/form-data">
            @csrf  
            <div class="row">   
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="contactPerson">
                                <div class="row mb-3 contactperson">
                                    ...
                                    <div class="col-md-6 mt-3">
                                        ...
                                        <input type="text" name="credit_day" class="form-control numeric" data-msg="Please enter credit days" placeholder="Credit Days" required>
                                    </div>
