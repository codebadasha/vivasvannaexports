        ...
        <div class="row">
            <div class="col-12">
                <div class="text-end mb-4">
                    ...
                    <a href="{{ route('admin.boq.create') }}" class="btn btn-primary"><i class="fa fa-plus pe-1"></i>Add</a>
                    @endif
                </div>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.boq.index') }}">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control select2" name="project" id="projectId">
                                        <option value="">Select Project</option>
                                        @forelse(\App\Models\Project::where('is_active',1)->where('is_delete',0)->get() as $sk => $sv)
                                        <option value="{{ $sv->id }}" {{ $sv->id == request()->project ? 'selected' : '' }}>{{ $sv->name }}</option>
                                        @empty
                                        <option value="">No Data Found</option>
                                        @endforelse
                                    </select>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary waves-effect waves-light viewProduct" href="javascript:void(0);" data-id="{{ $ov->id }}" role="button">
                                            View BOQ
                                        </a>
                                        @endif
