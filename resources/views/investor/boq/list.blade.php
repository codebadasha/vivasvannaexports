    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('investor.boq.index') }}">
                            <div class="row">  
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2 mt-2">
                                    ...
                                    @if($filter == 1)
                                        <a href="{{ route('investor.boq.index') }}" class="btn btn-danger mt-1 cancel_button" id="filter" name="save_and_list" value="save_and_list">
                                            Reset
                                        </a>
                                    @endif
                                </div>
                                ...
                                @foreach($getBoq as $ok => $ov)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('investor.po.index') }}?boq_id={{ base64_encode($ov->id) }}" role="button" target="_blank">
                                                Manage POs
                                            </a>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    $(document).on('click','.viewBoq',function(){
        $.ajax({
            url: "/investor-panel/boq/view-boq",
            type: "POST",
            dataType: "JSON",
