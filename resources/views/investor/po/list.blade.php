    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('investor.po.index') }}">
                            <div class="row">  
                                <div class="col-md-4">
                            ...
                            @if(!is_null($po))
                                @foreach($po as $ok => $ov)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('investor.po.viewPurchaseOrder',base64_encode($ov->id)) }}" role="button">
                                                View PO
                                            </a>
                                            <a class="btn btn-primary waves-effect waves-light" href="{{ route('investor.po.invoiceList',base64_encode($ov->id)) }}" role="button">
                                                View Invoices
                                            </a>
                                        </td>
                                    </tr>
