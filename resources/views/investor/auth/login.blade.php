            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0"> 
                        <div class="auth-logo">
                            <a href="{{ route('investor.login') }}" class="auth-logo-light">
                            ...
                            <a href="{{ route('investor.login') }}" class="auth-logo-dark">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{ asset('images/logo-vis.png') }}" alt="" class="" height="60">
                                    </span>
                        ...
                        <div class="p-2">
                            <form class="form-horizontal" action="{{ route('investor.postlogin') }}" id="loginForm" method="post">
                                @csrf
                                ...
                                <div class="mt-4 text-center">
                                    <a href="{{ route('investor.auth.password.reset') }}" class="text-muted"><i class="mdi mdi-lock me-1"></i> Forgot your password?</a>
                                </div>
                            </form>
                        </div>
                    </div>
